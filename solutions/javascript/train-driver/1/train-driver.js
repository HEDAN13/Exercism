 ...
 */
export const fixListOfWagons = (ids) => {
  const [a, b, ...rest] = ids;
  return [...rest, a, b];
};
 ...
 */
export const correctListOfWagons = (ids, missingWagons) => {
  const [locomotive, ...eachWagonsID] = ids;
  return [locomotive, ...missingWagons, ...eachWagonsID];
};
 ...
 */
export const separateTimeOfArrival = (information) => {
