...
export const assertHasId = (object) => {
  if (!("id" in object)) {
    (() => {
      throw new Error('The object is missing an "id" property or method');
    })();
  }
};
 ...
 */
export const hasIdProperty = (object) => object.hasOwnProperty("id");
...
export const hasDefinedType = (object) =>
  object.hasOwnProperty("type") && object.type !== undefined;
